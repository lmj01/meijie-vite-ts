...
export default defineComponent({
  name: 'Trackball',
  setup: () => {
    // https://discourse.threejs.org/t/zoom-to-cursor-with-trackball-controls/13333/4
    let TrackballControls = function ( object, domElement ) {
      ...
      var _state = STATE.NONE,
          ...
          _panEnd = new Vector2(),
          _mouseWheelLocation = new Vector2();
        ...
        return function zoomCamera() {
          ...
          if ( _state === STATE.TOUCH_ZOOM_PAN ) {
            ...
            if ( factor !== 1.0 && factor > 0.0 ) {
              ...
              var planeChange = new Vector2(dx * pz, dy * pz);
    ...
    **/
    ...
    const vertices = [];
    for (var i=0; i<500; i++) {
      vertices.push(Math.random() * 10, Math.random() * 10, 0);
    }
